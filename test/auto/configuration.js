...
var tests = {
	...
	'loadSave' : {
        ...
        '../templates/extras/Curriculum.xhtml' : '../../data/cvHaddock.xml',
        '../templates/extras/Carte-Resto.xhtml' : '../../data/carteResto1.xml',
        '../templates/extras/Publications.xhtml' : '../../data/publications.xml',
        '../templates/extras/Fiche-Cafe-Flow.xhtml' : '../../data/ficheCafeFlow.xml',
        '../templates/extras/Fiche-Projet.xhtml' : '../../data/ficheProjetW.xml',
